...
public class MascotaServicio {
    ...
    @Transactional
    public void agregarMascota(MultipartFile archivo, String idUsuario, String nombre, Sexo sexo) throws MiExcepcion{
    ...
    @Transactional
    public void modificar(MultipartFile archivo, String idUsuario, String idMascota, String nombre, Sexo sexo) throws MiExcepcion {
        validar(nombre, sexo);
